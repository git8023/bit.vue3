...
import { Decorators, fns, Builders, Cast, Functions } from '@git8023/toolkit.all-export';
import { vuex } from './types';
...
export class StoreTools {
   ...
   * @see namespaceX
   */
  static namespaceT<T extends object>(namespaced: string): T {
    return namespace(namespaced) as unknown as T;
  }
