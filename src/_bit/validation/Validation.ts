...
// import { AsyncArrayStream } from '../arrays/AsyncArrayStream';
...
export class Validation {
  ...
  static isEmpty<T>(o: T): boolean {
    ...
    if (this.isOr(o, 'Array', 'String')) {
      return 0 === (o as unknown as (Array<any> | 'String')).length;
    }

    if (this.is(o, 'Object')) {
      return 0 === Object.keys(o as unknown as object).length;
    }
